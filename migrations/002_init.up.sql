...
('Что делает функция runtime.Gosched() в Go?', '["Завершает текущую горутину", "Усыпляет текущую горутину", "Передает управление другой горутине", "Останавливает все горутины"]', 2, 'Функция runtime.Gosched() передает управление другой горутине, позволяя планировщику выполнить другие задачи.'),
...
('Что такое goroutine leak?', '["Потеря горутин", "Завершение горутин", "Утечка горутин", "Ошибка в горутине"]', 2, 'Goroutine leak — это утечка горутин, которая продолжает работать, когда она уже не нужна.'),
...
```', '["Ничего", "1357", "Зависит от версии языка", "Ошибка компиляции"]', 2, 'В версии 1.22 изменилась семантика for, поэтому вывод будет зависеть от версии'),
...
[playgroung](https://goplay.space/#ZXCOdU5Tql0)');
